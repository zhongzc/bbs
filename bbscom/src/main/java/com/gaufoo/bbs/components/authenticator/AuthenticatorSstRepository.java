...
public class AuthenticatorSstRepository implements AuthenticatorRepository {
    ...
    private AuthenticatorSstRepository(Path storingDir) {
    ...
    public static AuthenticatorSstRepository get(Path storingDir) {
        return new AuthenticatorSstRepository(storingDir);
    }

    public static void main(String[] args) {
        AuthenticatorSstRepository authenticatorSstRepository = new AuthenticatorSstRepository(Paths.get("resources").resolve("tst"));
