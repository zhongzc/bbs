...
public class SchoolHeatImpl implements SchoolHeat {
    ...
    private SchoolHeatImpl(SchoolHeatRepository repository, IdGenerator idGenerator) {
    ...
    public static SchoolHeatImpl get(SchoolHeatRepository repository, IdGenerator idGenerator) {
